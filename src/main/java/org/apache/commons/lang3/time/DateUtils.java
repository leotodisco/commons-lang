...
public class DateUtils {
  ...
  public static long getFragmentInMilliseconds(final Calendar calendar, final int fragment) {
    ...
    private static long getFragment(final Calendar calendar, final int fragment, final TimeUnit unit) {
        ...
        switch (fragment) {
            case Calendar.YEAR:
                result += unit.convert(calendar.get(Calendar.DAY_OF_YEAR) - (long) offset, TimeUnit.DAYS);
                break;
            case Calendar.MONTH:
                result += unit.convert(calendar.get(Calendar.DAY_OF_MONTH) - (long) offset, TimeUnit.DAYS);
                break;
            default:
                break;
        }
